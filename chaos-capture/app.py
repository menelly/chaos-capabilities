...
class App:
    ...
    def minimize(self):
        """Collapse to the FULL header strip / restore the card. Every
        button stays clickable while collapsed - nothing the user relies
        on ever disappears, the widget just gets short. (Ren, 8/16: the
        mystery dot is retired; the strip IS the minimized state.)"""

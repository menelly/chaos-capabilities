...
| Highlight a word, then — | `Ctrl+Alt+A` | **add it to your dictionary** right there. ANY highlighted text, anywhere — your typed fix, a word it transcribed correctly, a name on a webpage or in an email. No typing required: see the word, highlight it, press this, done — every future take knows it |
